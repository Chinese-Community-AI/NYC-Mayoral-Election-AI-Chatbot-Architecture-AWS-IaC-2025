...
const mockOutputs = {
  appsync_graphql_endpoint: {
    ...
    type: "string",
    value:
      "https://example-mock-endpoint.appsync-api.us-east-1.amazonaws.com/graphql",
  },
  appsync_api_key: {
    sensitive: true,
    type: "string",
...
console.log("");
console.log(
  "Note: The frontend will not be able to connect to a real backend with these mock values."
);
console.log(
  "This is only useful for UI development and testing the frontend components."
);
